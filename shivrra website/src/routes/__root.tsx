...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SHIVRRA is a luxury fragrance house. Discover Moon Oud — a deep, mysterious, unforgettable unisex eau de parfum." },
      { name: "author", content: "SHIVRRA" },
      ...
      { name: "twitter:site", content: "@shivrra" },
    ],
    links: [
